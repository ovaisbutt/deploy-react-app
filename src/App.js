...
export default class App extends Component {
  render() {
    return (
      <div className="d-flex justify-content-center align-self-center align-items-center flex-column col-sm-12">
        <div className="d-flex justify-content-center align-self-center align-items-center flex-column">
          <h1 style={{ color: "white", fontSize: 70, marginTop: 20 }} >Waleed &amp; Tooba</h1>
